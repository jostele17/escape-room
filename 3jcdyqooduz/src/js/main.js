...
//Pregunta 1
jQuery("#dia-3-pregunta-1-btn").click(function () {
    var resp = $("#dia-3-pregunta-1-inp").val();
    $.getJSON("../../json/t.json", function (data) {
        var respuesta = data[1].respuesta;
        if (respuesta.localeCompare(resp) == 0) {
            console.log("respuesta correcta");
            $(location).attr('href', '../../r/bcazqgc7k');
        } else {
...
//Pregunta 3
jQuery("#dia-3-pregunta-3-btn").click(function () {
    var resp = $("#dia-3-pregunta-3-inp").val();
    $.getJSON("../../json/t.json", function (data) {
        var respuesta = data[3].respuesta;
        if (respuesta.localeCompare(resp) == 0) {
            console.log("respuesta correcta");
            $(location).attr('href', '../../r/dq70kcfbz');
        } else {
            jQuery('#user-help').text('Clave incorrecta');
        }
    });
...
//Pregunta 4
jQuery("#dia-3-pregunta-4-btn").click(function () {
    $(location).attr('href', '../../r/e9257zww');
});
//Pregunta 5
jQuery("#dia-3-pregunta-5-btn").click(function () {
    var resp = $("#dia-3-pregunta-5-inp").val();
    $.getJSON("../../json/t.json", function (data) {
        var respuesta = data[5].respuesta;
        if (respuesta.localeCompare(resp) == 0) {
            console.log("respuesta correcta");
            $(location).attr('href', '../../r/fbqq5nhi0');
        } else {
            jQuery('#user-help').text('Clave incorrecta');
        }
    });
